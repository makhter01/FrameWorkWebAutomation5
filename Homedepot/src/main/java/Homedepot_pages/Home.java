...
public class Home extends CommonAPI {
    ...
    public static WebElement accountSignIn;
    ...
    @FindBy(xpath="//*[@id=\'email_id\'][@class= \'form-input__field invalid\']")
    public static WebElement emailInput;

    @FindBy(css="#password")
    public static WebElement signPassword;

    @FindBy(css="input#registrationPassword")
    ...
    public static WebElement registerButtonReg;
    ...
    public void navigateTosignIn(WebDriver driver) throws InterruptedException {
        ...
        while (it.hasNext()) {
            ...
            if (MainWindow.equalsIgnoreCase(ChildWindow)) {
                ...
                signPassword.sendKeys("abcd1234");
                accountSignIn.click();
    ...
    public void clickRegister(WebDriver driver)throws InterruptedException {
        ...
        for (String handle : driver.getWindowHandles()) {
            driver.switchTo().window(handle);
                ...
                emailInput.sendKeys("testuser2@gmail.com");
                regpassword.sendKeys("abcd1234");
                confirmPassword.sendKeys("abcd1234");
                zipcode.sendKeys("11201");
